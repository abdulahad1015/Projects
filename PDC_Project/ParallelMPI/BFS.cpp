...
//INPUT MUST BE GIVEN THROUGH COMMAND LINE IN FORM OF ARGUMENTS,THIS IS MORE LOGICAL APPROACH TOWARDS MPI
bool isClear(int[], long int, long int,long int );
int getIndex(int i,int j ,int rowSize);

int main (int argc, char *argv[])
{
    unsigned int rowNo, columnNo; 
    unsigned int noofPRows;       
    unsigned int noofVertices;    
    unsigned int noofVerticesPerProcessor; 
    ...
    unsigned int noofVerticesinRowofProcessor = noofVerticesPerProcessor*noofPRows;
